...
function getChatGPTResponse(question) {
  const openaiApiKey = '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';
  ...
  return fetch(apiUrl, { method: 'POST', headers, body: data })
...
function setBotResponse(response) {
  ...
  setTimeout(() => {
    ...
    if (response.length < 1) {
      ...
      const fallbackMsg = getChatGPTResponse(Message)
